...
<body>
	...
	<div id="info">
    	<div id="teacher_info_container">
        	<div class="sub_title" id="teacher_info">教师信息 <span id="log_out" onClick="log_out()">注销</span></div>
        ...
        <div id="add_course">
            ...
            <div class="content">
            	<table cellspacing="5px">
                    ...
                    <tr>
                    	<td>学时</td>
                        <td><input type="text" class="input_text" id="course_hour" name="course_hour"></td>
                    </tr>
                    <tr>
